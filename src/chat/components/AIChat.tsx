      ...
      <div className="bg-white rounded-lg shadow-md p-4 w-[400px]">
        ...
        <form className="mt-4 flex items-center" onSubmit={handleSendMessage}>
          <input
            ...
            className="flex-1 py-2 px-3 rounded-xl bg-gray-100 border-gray-300  focus:border-pignus-500 active:focus:border-pignus-500 focus:outline-none focus:ring focus:ring-pignus-500 focus:ring-opacity-50 transition duration-100 ease-in-out"
          />
          <button
            className="bg-pignus-500 text-white px-4 py-2 rounded-xl ml-3 hover:bg-pignus-600"
            type="submit"
          >
            Enviar
          </button>
